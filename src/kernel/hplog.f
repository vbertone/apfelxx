...
** setting the immaginary parts equal to zero
      call apf_psetzero(nw,Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
...
************************************************************************
      subroutine apf_peval1dhplat0(y,nw,H1,H2,H3,H4,H5,
     $                          HY1,HY2,HY3,HY4,HY5,
...
** evaluate the irreducible 1dHPL's first
      call apf_pfillh1(y,H1,HY1,Hi1,n1,n2)
      if ( nw.eq.1 ) return
      call apf_pfillirr1dhplat0(y,nw,HY1,HY2,HY3,HY4,HY5,n1,n2)
** then the reducible 1dHPL's
      call apf_pfillred1dhpl(nw,H1,H2,H3,H4,H5,
     $              HY1,HY2,HY3,HY4,HY5,Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
      return
      end
************************************************************************
      subroutine apf_peval1dhplin1(y,nw,H1,H2,H3,H4,H5,
     $                   HY1,HY2,HY3,HY4,HY5,Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
...
** evaluate the irreducible 1dHPL's first
      call apf_pfillh1(y,H1,HY1,Hi1,n1,n2)
      if ( nw.eq.1 ) return
      call apf_pfillirr1dhplin1(y,nw,HY1,HY2,HY3,HY4,HY5,n1,n2)
** then the reducible 1dHPL's
      call apf_pfillred1dhpl(nw,H1,H2,H3,H4,H5,
     $                HY1,HY2,HY3,HY4,HY5,Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
      if (n2.eq.0) return
...
************************************************************************
      subroutine apf_peval1dhplat1(y,nw,H1,H2,H3,H4,H5,
     $                 HY1,HY2,HY3,HY4,HY5,Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
...
** the whole (-1,1) range is in general needed for any pair (n1,n2)
      call apf_pfillirr1dhplat0(r,nw,HR1,HR2,HR3,HR4,HR5,-1,1)
** fillirr1dhplat1 takes care automatically of all the immaginary
** parts as well as of the jump across y=1
      call apf_pfillirr1dhplat1(r,nw,HR1,HR2,HR3,HR4,HR5,
     $                          HY1,HY2,HY3,HY4,HY5,
     $                          Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
** then the reducible 1dHPL's
      call apf_pfillred1dhpl(nw,H1,H2,H3,H4,H5,
...
************************************************************************
      subroutine apf_peval1dhplatinf(y,nw,H1,H2,H3,H4,H5,
     $                  HY1,HY2,HY3,HY4,HY5,Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
...
*      print*,' eval1dhplatinf: y = ',y,', x = ',x
      call apf_pfillirr1dhplat0(x,nw,HX1,HX2,HX3,HX4,HX5,n1,n2)
** fillirr1dhplatinf takes care automatically of all the immaginary
** parts as well as of the jump across y=1
      call apf_pfillirr1dhplatinf(x,nw,HX1,HX2,HX3,HX4,HX5,
     $                            HY1,HY2,HY3,HY4,HY5,
     $                            Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
** then the reducible 1dHPL's
      call apf_pfillred1dhpl(nw,H1,H2,H3,H4,H5,
...
************************************************************************
      subroutine apf_peval1dhplinm1(y,nw,H1,H2,H3,H4,H5,
     $                 HY1,HY2,HY3,HY4,HY5,Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
** evaluates 1dhpl's for y=-1 (explicit values are tabulated)
      implicit double precision (a-h,o-z)
      complex*16 H1,H2,H3,H4,H5
...
** evaluate H(...,-y)
      call apf_psetzero(nw,Gi1,Gi2,Gi3,Gi4,Gi5,-n2,-n1)
      Gi1(0) = -1
      call apf_peval1dhplin1(-y,nw,G1,G2,G3,G4,G5,
...
************************************************************************
      subroutine apf_peval1dhplatm1(y,nw,H1,H2,H3,H4,H5,
     $                    HY1,HY2,HY3,HY4,HY5,Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
** evaluates 1dhpl's in the (-1)-range  -(r2+1) < y <= -(r2-1)
...
** evaluate H(...,-y)
      call apf_psetzero(nw,Gi1,Gi2,Gi3,Gi4,Gi5,-n2,-n1)
      Gi1(0) = -1
      call apf_peval1dhplat1(-y,nw,G1,G2,G3,G4,G5,
     $                  GY1,GY2,GY3,GY4,GY5,Gi1,Gi2,Gi3,Gi4,Gi5,-n2,-n1)
      if (infilldim.eq.2) then
         do i=1,2
            infill(i) = istorfill(i)
...
** fill the arrays H's
     ...
     $                dcmplx(HY5(k1,k2,k3,k4,k5),Hi5(k1,k2,k3,k4,k5)*pi)
      ...
      subroutine apf_peval1dhplatminf(y,nw,H1,H2,H3,H4,H5,
     $                   HY1,HY2,HY3,HY4,HY5,Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
...
** evaluate H(...,-y)
      call apf_psetzero(nw,Gi1,Gi2,Gi3,Gi4,Gi5,-n2,-n1)
      Gi1(0) = -1
      call apf_peval1dhplatinf(-y,nw,G1,G2,G3,G4,G5,
     $                  GY1,GY2,GY3,GY4,GY5,Gi1,Gi2,Gi3,Gi4,Gi5,-n2,-n1)
      if (infilldim.eq.2) then
         do i=1,2
            infill(i) = istorfill(i)
...
************************************************************************
      subroutine apf_psetzero(nw,Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
...
************************************************************************
      subroutine apf_pfillred1dhpl(nw,H1,H2,H3,H4,H5,
     $                 HY1,HY2,HY3,HY4,HY5,Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
...
** iflag = 0 to suppress auxiliary printings of FILLREDHPLx
      ...
      do ia =  1,infilldim
      do ib = ia,infilldim
        call apf_pFILLREDHPL2(iflag,H1,H2,n1,n2,infill(ia),infill(ib))
        if ( nw.gt.2 ) then
          do ic = ib,infilldim
            call apf_pFILLREDHPL3(iflag,H1,H2,H3,n1,n2,
     $                          infill(ia),infill(ib),infill(ic))
            if ( nw.gt.3 ) then
              do id = ic,infilldim
                call apf_pFILLREDHPL4(iflag,H1,H2,H3,H4,n1,n2,
     $               infill(ia),infill(ib),infill(ic),infill(id))
      ...
      enddo
      enddo
      if (nw.gt.4) call apf_pFILLREDHPL5(iflag,H1,H2,H3,H4,H5,n1,n2)
...
************************************************************************
      subroutine apf_pFILLREDHPL2(iflag,H1,H2,i1,i2,na,nb)
      implicit double precision (a-h,o-z)
      complex*16 H1,H2
...
*      print*,' FILLREDHPL2, iflag =',iflag
      if ( na.eq.nb ) then
        ...
        if ( iflag.eq.1 ) then
          call apf_pprinter2(na,nb)
        endif
      endif
      return
      end
************************************************************************
      subroutine apf_pFILLREDHPL3(iflag,H1,H2,H3,i1,i2,ia,ib,ic)
      implicit double precision (a-h,o-z)
      complex*16 H1,H2,H3
...
* case (na,nb,nc)    all indices are different
        ...
        nc = ic
        if ( iflag.eq.1 ) then
          call apf_pprinter3(na,nb,nc)
          call apf_pprinter3(na,nc,nb)
        endif
...
************************************************************************
      subroutine apf_pFILLREDHPL4(iflag,H1,H2,H3,H4,i1,i2,ia,ib,ic,id)
      implicit double precision (a-h,o-z)
...
* case (na,na,na,nb)
     ...
     $                    + H1(na)*H3(na,na,nb) - H4(na,na,na,nb)
        if ( iflag.eq.1 ) then
          call apf_pprinter4(na,na,na,nb)
        endif
* ic cannot be anymore equal to ia
      else if ( ic.eq.ia ) then
...
* case (na,na,nb,nb)
     ...
     $                    + H1(nb)*H3(na,na,nb) - H4(na,na,nb,nb)
        if ( iflag.eq.1 ) then
          call apf_pprinter4(na,na,nb,nb)
        endif
      else if ( ia.eq.ib ) then
* case (na,na,nb,nc)
        nb = ic
     ...
     $                    - H4(na,na,nb,nc)
        if ( iflag.eq.1 ) then
          call apf_pprinter4(na,na,nb,nc)
          call apf_pprinter4(na,na,nc,nb)
          call apf_pprinter4(na,nb,na,nc)
        endif
* ib cannot be anymore equal to ia
      else if ( ib.eq.ia ) then
...
* case (na,nb,nb,nb)
     ...
     $                    + H1(nb)*H3(na,nb,nb) - H4(na,nb,nb,nb)
        if ( iflag.eq.1 ) then
          call apf_pprinter4(na,nb,nb,nb)
        endif
...
* case (na,nb,nb,nc)
     ...
     $                    - H4(na,nb,nb,nc)
        if ( iflag.eq.1 ) then
          call apf_pprinter4(na,nb,nb,nc)
          call apf_pprinter4(na,nb,nc,nb)
          call apf_pprinter4(na,nc,nb,nb)
        endif
...
* case (na,nb,nc,nc)
     ...
     $                    + H1(nc)*H3(na,nb,nc) - H4(na,nb,nc,nc)
        if ( iflag.eq.1 ) then
          call apf_pprinter4(na,nb,nc,nc)
          call apf_pprinter4(na,nc,nb,nc)
          call apf_pprinter4(na,nc,nc,nb)
        endif
...
* case (na,nb,nc,nd) all indices are different
     ...
     $                    + H2(na,nb)*H2(nc,nd) - H4(na,nb,nc,nd)
        if ( iflag.eq.1 ) then
          call apf_pprinter4(na,nb,nc,nd)
          call apf_pprinter4(na,nb,nd,nc)
          call apf_pprinter4(na,nc,nb,nd)
          call apf_pprinter4(na,nc,nb,nd)
          call apf_pprinter4(na,nd,nb,nc)
          call apf_pprinter4(na,nd,nc,nb)
        endif
      endif
*23456789012345678901234567890123456789012345678901234567890123456789012
      return
...
************************************************************************
      subroutine apf_pprinter2(na,nb)

      write(11,'(''g [H('',$)')
      call apf_psubprint(11,na)
      write(11,'('','',$)')
      call apf_psubprint(11,nb)
      write(11,'('',y)] = H('',$)')
      call apf_psubprint(11,na)
      write(11,'('','',$)')
      call apf_psubprint(11,nb)
      ...
      write(12,'(''id H('',$)')
      call apf_psubprint(12,na)
      write(12,'('','',$)')
      call apf_psubprint(12,nb)
      write(12,'('',y) = H[('',$)')
      call apf_psubprint(12,na)
      write(12,'('','',$)')
      call apf_psubprint(12,nb)
...
***
      subroutine apf_pprinter3(na,nb,nc)
...
***
      subroutine apf_pprinter4(na,nb,nc,nd)
...
***
  ...
  102 format(i2,$)
      ...
      subroutine apf_pFILLREDHPL5(iflag,HZ1,HZ2,HZ3,HZ4,HZ5,n1,n2)
      implicit double precision (a-h,o-z)
...
************************************************************************
      subroutine apf_pfillh1(y,H1,HY1,Hi1,n1,n2)
...
************************************************************************
      subroutine apf_pfillirr1dhplat0(y,nw,HY1,HY2,HY3,HY4,HY5,n1,n2)
...
************************************************************************
      subroutine apf_pfillirr1dhplat1(r,nw,HR1,HR2,HR3,HR4,HR5,
     $                                HY1,HY2,HY3,HY4,HY5,
     $                                Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
...
************************************************************************
      subroutine apf_pfillirr1dhplatinf(x,nw,HX1,HX2,HX3,HX4,HX5,
     $                                HY1,HY2,HY3,HY4,HY5,
     $                                Hi1,Hi2,Hi3,Hi4,Hi5,n1,n2)
...
************************************************************************
      subroutine apf_pfillirr1dhplin1(y,nw,HY1,HY2,HY3,HY4,HY5,n1,n2)
