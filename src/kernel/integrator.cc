...
namespace apfel
{
  ...
  const std::array<std::vector<double>,5> gq_x =
	...
	std::vector<double>{0.0950125098376374, 0.2816035507792589, 0.4580167776572273, 0.6178762444026437,
			    0.7554044083550030, 0.8656312023878317, 0.9445750230732325, 0.9894009349916499},
	std::vector<double>{0.0483076656877383, 0.1444719615827964, 0.2392873622521370, 0.3318686022821276,
	...
	std::vector<double>{0.0243502926634244, 0.0729931217877990, 0.1214628192961205, 0.1696444204239928,
  ...
  const std::array<std::vector<double>,5> gq_w =
	...
	std::vector<double>{0.1894506104550684, 0.1826034150449235, 0.1691565193950025, 0.1495959888165767,
			    0.1246289712555338, 0.0951585116824927, 0.0622535239386478, 0.0271524594117540},
	std::vector<double>{0.0965400885147278, 0.0956387200792748, 0.0938443990808045, 0.0911738786957638,
	...
	std::vector<double>{0.0486909570091397, 0.0485754674415034, 0.0483447622348029, 0.0479993885964583,
