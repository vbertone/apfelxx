...
\langle z_i\rangle\quad\mbox{and}\quad \langle z_iz_j\rangle = \delta_{ij}\,,
\end{equation}
where the symbol $\langle\,\dots\rangle$ indicates the average.  This
immediatelly tells us that:
\begin{equation}
