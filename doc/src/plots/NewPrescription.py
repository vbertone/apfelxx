...
plt.ylabel(r"$\displaystyle \frac{{\rm d}\sigma}{{\rm d}Q{\rm d}y{\rm d}q_{\rm T}}$ \textbf{[pb/GeV$^2$]}")
plt.text(2.5, 1.5, r"\textbf{N$^3$LL}")
plt.text(2.5, 1.0, r"\textbf{NNPDF3.1 NNLO luxQED}")
plt.text(2.5, 0.5, r"$Q=M_Z\,,\;y=0$")
plt.xlim(0, 20)
plt.ylim(0, 4)
plt.plot(data[0:50, 2], data[0:50, 3], c = "blue", linestyle = "-", label = r"\textbf{CSS}")
plt.plot(data[0:50, 2], data[0:50, 6], c = "red",  linestyle = "-", label = r"\textbf{Alternative}")
plt.legend()
...
# CSS
plt.xlabel(r"$q_{\rm T}$ \textbf{[GeV]}")
plt.ylabel(r"$\frac{{\rm d}\sigma}{{\rm d}Q{\rm d}y{\rm d}q_{\rm T}}$")
plt.xlim(0, 20)
plt.ylim(0, 4)
plt.plot(data[0:50, 2], data[0:50, 3], c = "blue", linestyle = "-", label = r"$b_0/b_{\rm max} = 1$")
...
plt.xlim(0, 20)
plt.ylim(0, 4)
plt.plot(data[0:50, 2], data[0:50, 6], c = "red", linestyle = "-", label = r"$b_0/b_{\rm max} = 1$")
...
# CSS in bT
plt.xlabel(r"$b_{\rm T}$ \textbf{[GeV$^{-1}$]}")
plt.ylabel(r"$b_{\rm T}\widetilde{\sigma}(b_{\rm T})$")
plt.xlim(0, 1.5)
plt.ylim(0, 4)
plt.plot(data[50:150, 2], data[50:150, 3], c = "blue", linestyle = "-", label = r"$b_0/b_{\rm max} = 1$")
...
plt.xlim(0, 1.5)
plt.ylim(0, 4)
plt.plot(data[50:150, 2], data[50:150, 6], c = "red", linestyle = "-", label = r"$b_0/b_{\rm max} = 1$")
