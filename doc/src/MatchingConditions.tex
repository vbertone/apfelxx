...
\end{array}
\end{equation}
the convolutions Eq.~(\ref{eq:squareK1}) could possibly be computed
analytically. We notice that the $\mathcal{O}(\alpha_s^2)$ correction
to these functions is currently unknown, therefore we only use the
$\mathcal{O}(\alpha_s)$ expressions.
