...
$\mathcal{O}(\alpha_s^2)$:
\begin{equation}\label{eq:Cmu0z0}
\begin{array}{rcl}
  ...
  \\
                   &+&\displaystyle
                       ...
                       -\gamma_K^{(0)} P^{(0)}-\frac23 \beta_0 \gamma_K^{(0)}\right) L_{\mu}^3\\
  \\
...
Accounting for the fact that $K^{(0,0)}=0$, Eq.~(\ref{eq:Cmu0z0})
reduces to:
\begin{equation}
\begin{array}{rcl}
  C(\mu_0,\zeta_0) &=&\displaystyle 1+a_b\left[
                       C^{(1,0)}+\left(\gamma_F^{(0)}
                       -2P^{(0)}\right)L_{\mu}+\frac12\gamma_K^{(0)}\left(L_{\mu}^2-2 L_{\mu} L_{\zeta}\right)\right]\\
  \\
                   &+&\displaystyle a_b^2\bigg[C^{(2,0)}+\left(\gamma_F^{(1)} -2P^{(1)}+\gamma_F^{(0)}C^{(1,0)}
                       -2P^{(0)}\otimes C^{(1,0)}\right)L_{\mu}
                       +K^{(1,0)}L_{\zeta} \\
  \\
                   &+&\displaystyle \left(-\beta_0 \gamma_F^{(0)}+2 \beta_0
                       ...
                       \gamma_F^{(0)} P^{(0)} +2P^{(0)}\otimes P^{(0)}+\frac12\gamma_K^{(1)}+\frac12\gamma_K^{(0)}C^{(1,0)}\right)L_{\mu}^2\\
  \\
                   &+&\displaystyle \left(-\gamma_K^{(1)}-\gamma_K^{(0)}C^{(1,0)}\right) L_{\mu}L_{\zeta}+
                       \left(\frac12\gamma_K^{(0)}\gamma_F^{(0)}
                       -\gamma_K^{(0)} P^{(0)}-\frac23 \beta_0 \gamma_K^{(0)}\right) L_{\mu}^3\\
  \\
                   &+&\displaystyle \left(-\gamma_K^{(0)}\gamma_F^{(0)}
                       +2 \gamma_K^{(0)} P^{(0)}+\beta_0 \gamma_K^{(0)}\right) L_{\mu}^2 L_{\zeta}+
                       \frac18\left(\gamma_K^{(0)}\right)^2\left(L_{\mu}^2-2L_\mu
                       L_{\zeta}\right)^2\bigg]+\mathcal{O}(\alpha_s^3)\,.
\end{array}
\end{equation}
In addition, to simplify the structure even further, one may take:
\begin{equation}
L_\mu=L_\zeta=L_0\,,
\end{equation}
so that:
\begin{equation}
\begin{array}{rcl}
  C(\mu_0,\mu_0^2) &=&\displaystyle 1+a_b\left[
                       C^{(1,0)}+\left(\gamma_F^{(0)}
                       -2P^{(0)}\right)L_0-\frac12\gamma_K^{(0)}L_0^2\right]\\
  \\
                   &+&\displaystyle a_b^2\bigg[C^{(2,0)}+\left(\gamma_F^{(1)} +K^{(1,0)}-2P^{(1)}+\gamma_F^{(0)}C^{(1,0)}
                       -2P^{(0)}\otimes C^{(1,0)}\right)L_0
                       \\
  \\
                   &+&\displaystyle \left(-\beta_0 \gamma_F^{(0)}+2 \beta_0
                       P^{(0)}+\frac12\left(\gamma_F^{(0)}\right)^2 -2
                       \gamma_F^{(0)} P^{(0)} +2P^{(0)}\otimes P^{(0)}-\frac12\gamma_K^{(1)}-\frac12\gamma_K^{(0)}C^{(1,0)}\right)L_0^2\\
  \\
                   &+&\displaystyle 
                       \left(-\frac12\gamma_K^{(0)}\gamma_F^{(0)}
                       +\gamma_K^{(0)} P^{(0)}+\frac13 \beta_0 \gamma_K^{(0)}\right) L_0^3+
...
\\
  &=&\displaystyle  1+\left(\frac{\alpha_s(\mu)}{4\pi}\right)H^{(1)}+\left(\frac{\alpha_s(\mu)}{4\pi}\right)^2\left(H^{(2)}-2\beta_0H^{(1)}\ln\frac{\mu}{Q}\right)+\mathcal{O}(\alpha_s^3)\,,
\end{array}
\end{equation}
