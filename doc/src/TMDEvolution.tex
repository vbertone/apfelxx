...
\begin{equation}\label{eq:ansolutnnll}
  a_s^{\rm NNLL}(\mu)=a_s^{\rm LL}(\mu)\left[1-b_1 a_s^{\rm LL}(\mu) \left[1+ a_s^{\rm NLL}(\mu)\right]\ln\left(\frac{a_s(\mu_0)}{a_s^{\rm
        LL}(\mu)}\right)+\displaystyle (b_2-b_1^2) a_s^{\rm LL}(\mu) \left[a_s^{\rm
...
\end{equation}
Assuming that $x\ll 1$ (as it should to be in the perturbative
...
in terms of the coefficients ${b}_n$. Plugging this expansion into
Eq.~(\ref{eq:intrun}) and solving the integrals gives:
\begin{equation}
...
\begin{array}{rcl}
  ...
  \\
              &=&\displaystyle a_{\rm LL}\left\{1-a_{\rm LL}\left[\overline{b}_1 \ln\left(\frac{a_{\rm
                  ...
                  LL}^2 \overline{b}_1^2\ln\left(\frac{a_{\rm LL}}{a_0}\right)\left(1+\frac12 \ln^2\left(\frac{a_{\rm LL}}{a_0}\right)\right)\right\}+\mathcal{O}(a^4)\,.
\end{array}
\end{equation}
...
JHEP \textbf{03} (2007), 039
doi:10.1088/1126-6708/2007/03/039
[arXiv:hep-ph/0701127 [hep-ph]].
%125 citations counted in INSPIRE as of 15 Sep 2020

%\cite{Bogolyubov:1960cha}
\bibitem{Bogolyubov:1960cha}
N.~N.~Bogolyubov, A.~A.~Logunov and D.~V.~Shirkov,
%``The method of dispersion relations and perturbation theory,''
Sov. Phys. JETP \textbf{10} (1960) no.3, 574-581.
%69 citations counted in INSPIRE as of 03 Oct 2020
...
Phys. Rev. D \textbf{72} (2005), 074014
doi:10.1103/PhysRevD.72.074014
[arXiv:hep-ph/0506311 [hep-ph]].
%97 citations counted in INSPIRE as of 03 Oct 2020
