...
\begin{array}{rclclcl}
  \Theta^{\beta\delta,\alpha\gamma} &=& C_{\rm LL} \,
                                        \delta_{\beta\delta}\delta_{\alpha\gamma}
  &+& \displaystyle\left[{\rm LS}+{\rm SS}\ln(1-c_{\beta\delta})\right]\,\delta_{\beta\delta}\Gamma_{\alpha\gamma}^{\rm S1}
  &+&\displaystyle \delta_{\beta\delta} \left[\Gamma_{\alpha\gamma}^{\rm LR}+\ln(1-c_{\beta\delta})\Gamma_{\alpha\gamma}^{\rm
                                     SR}\right]\\
  \\
                                    &+&\displaystyle\Gamma_{\beta\delta}^{\rm S1}\,\left[{\rm SL}+{\rm SS}\ln(1-c_{\alpha\gamma})\right]\,\delta_{\alpha\gamma} 
  &+&
     {\rm SS}\,\Gamma_{\beta\delta}^{\rm
      S0}\Gamma_{\alpha\gamma}^{\rm S0}&+& \Gamma_{\beta\delta}^{\rm S0}\Gamma_{\alpha\gamma}^{\rm SR}\\
\\
&+& \displaystyle \left[\Gamma_{\beta\delta}^{\rm RL}+\ln(1-c_{\alpha\gamma})\Gamma_{\beta\delta}^{\rm RS}\right]\delta_{\alpha\gamma} &+& \Gamma_{\beta\delta}^{\rm RS}\Gamma_{\alpha\gamma}^{\rm
...
\begin{equation}
\begin{array}{rcl}
C_{\rm LL} &=& \displaystyle  {\rm
                                        LL}+{\rm
                                        LS}\frac12\ln^2\left(1-c_{\alpha\gamma}\right)+{\rm
                                        SL}\frac12\ln^2\left(1-c_{\beta\delta}\right)+{\rm
                                        SS}\ln\left(1-c_{\beta\delta}\right)\ln\left(1-c_{\alpha\gamma}\right)
\end{array}
\end{equation}
and:
...
\begin{array}{rcl}
  \Gamma_{\alpha\beta}^{{\rm S}n} &=& \displaystyle  \int_{c_{\alpha\beta}}^{d_{\alpha\beta}}
                                       dz\frac{\ln^n(1-z)}{1-z}\left[w_{\beta}^{(k)}\left(\frac{x_\alpha}{z}\right)-\delta_{\alpha\beta}\right]\\
  \\
...
\end{equation}
This technology will be useful for more complicated observables, like
...
Eq.~(\ref{eq:OpSeries}) by identifying number of form of the
...
has $r$ terms, the series in Eq.~(\ref{eq:OpSeries}) has $15+r$ terms
at most, that is:
\begin{equation}\label{eq:OpSeriesCon}
\Theta^{\beta\delta,\alpha\gamma} = \sum_{j=1}^{15+r} C_j\Gamma_j^{(1),\beta\delta}\Gamma_j^{(2),\alpha\gamma}
\end{equation}
with:
\begin{equation}
\begin{array}{lclll}
j = 1 &:& C_1 = {\rm LL}, & \Gamma_1^{(1),\beta\delta} = \delta_{\beta\delta}, & \Gamma_1^{(2),\alpha\gamma} = \delta_{\alpha\gamma},\\
j = 2 &:& C_2 = {\rm LS}/{2}, & \Gamma_2^{(1),\beta\delta} = \delta_{\beta\delta}, & \Gamma_2^{(2),\alpha\gamma} = \ln^2\left(1-c_{\alpha\gamma}\right)\delta_{\alpha\gamma},\\
j = 3 &:& C_3 = {\rm SL}/{2}, & \Gamma_3^{(1),\beta\delta} = \ln^2\left(1-c_{\beta\delta}\right)\delta_{\beta\delta}, & \Gamma_3^{(2),\alpha\gamma} = \delta_{\alpha\gamma},\\
j = 4 &:& C_4 = {\rm SS}, & \Gamma_4^{(1),\beta\delta} = \ln\left(1-c_{\beta\delta}\right)\delta_{\beta\delta}, & \Gamma_4^{(2),\alpha\gamma} = \ln\left(1-c_{\alpha\gamma}\right)\delta_{\alpha\gamma},\\
j = 5 &:& C_5 = {\rm LS}, & \Gamma_5^{(1),\beta\delta} = \delta_{\beta\delta}, & \Gamma_5^{(2),\alpha\gamma} = \Gamma_{\alpha\gamma}^{\rm S1},\\
j = 6 &:& C_6 = {\rm SS}, & \Gamma_6^{(1),\beta\delta} = \ln(1-c_{\beta\delta})\delta_{\beta\delta}, & \Gamma_6^{(2),\alpha\gamma} = \Gamma_{\alpha\gamma}^{\rm S1},\\
j = 7 &:& C_7 = 1, & \Gamma_7^{(1),\beta\delta} = \delta_{\beta\delta}, & \Gamma_7^{(2),\alpha\gamma} = \Gamma_{\alpha\gamma}^{\rm LR},\\
j = 8 &:& C_8 = 1, & \Gamma_8^{(1),\beta\delta} = \ln(1-c_{\beta\delta})\delta_{\beta\delta}, & \Gamma_8^{(2),\alpha\gamma} = \Gamma_{\alpha\gamma}^{\rm SR},\\
j = 9 &:& C_9 = {\rm SL}, & \Gamma_9^{(1),\beta\delta} = \Gamma_{\beta\delta}^{\rm S1}, & \Gamma_9^{(2),\alpha\gamma} = \delta_{\alpha\gamma},\\
j = 10 &:& C_{10} = {\rm SS}, & \Gamma_{10}^{(1),\beta\delta} = \Gamma_{\beta\delta}^{\rm S1}, & \Gamma_{10}^{(2),\alpha\gamma} = \ln(1-c_{\alpha\gamma})\delta_{\alpha\gamma},\\

j = 11 &:& C_{11} = {\rm SS},& \Gamma_{11}^{(1),\beta\delta} = \Gamma_{\beta\delta}^{\rm S0}, & \Gamma_{11}^{(2),\alpha\gamma} = \Gamma_{\alpha\gamma}^{\rm S0},\\
j = 12 &:& C_{12} = 1, & \Gamma_{12}^{(1),\beta\delta} = \Gamma_{\beta\delta}^{\rm S0}, & \Gamma_{12}^{(2),\alpha\gamma} = \Gamma_{\alpha\gamma}^{\rm SR},\\
j = 13 &:& C_{13} = 1, & \Gamma_{13}^{(1),\beta\delta} = \Gamma_{\beta\delta}^{\rm RL}, & \Gamma_{13}^{(2),\alpha\gamma} = \delta_{\alpha\gamma},\\
j = 14 &:& C_{14} = 1, & \Gamma_{14}^{(1),\beta\delta} = \Gamma_{\beta\delta}^{\rm RS}, & \Gamma_{14}^{(2),\alpha\gamma} = \ln(1-c_{\alpha\gamma})\delta_{\alpha\gamma},\\
j = 15 &:& C_{15} = 1, & \Gamma_{15}^{(1),\beta\delta} = \Gamma_{\beta\delta}^{\rm RS}, & \Gamma_{15}^{(2),\alpha\gamma} = \Gamma_{\alpha\gamma}^{\rm S0},\\
j = 16 &:& C_{16} = K_1 & \Gamma_{14}^{(1),\beta\delta} = \Gamma_{\beta\delta}^{R_1^{(1)}}, & \Gamma_{16}^{(2),\alpha\gamma} = \Gamma_{\alpha\gamma}^{R_1^{(2)}},\\
\vdots & & & & \\
j = 15 + r &:& C_{15+r} = K_r & \Gamma_{15+r}^{(1),\beta\delta} = \Gamma_{\beta\delta}^{R_r^{(1)}}, & \Gamma_{15+r}^{(2),\alpha\gamma} = \Gamma_{\alpha\gamma}^{R_r^{(2)}}
\end{array}
\end{equation}
...
the structure of the SIDIS observables of the expressions for the
respective hard cross sections can be found in
Ref.~\cite{deFlorian:1997zj}. Following this paper, the SIDIS differential
cross section for the exchange of a virtual photon can be written as:
...
addition factor two due to the difference in the expansion parameter
($\alpha_s/4\pi$ rather than $\alpha_s/4\pi$) and to combine the
...
\\
&+&\displaystyle 2(1+6x+2x^2) + (x^2+(1-x)^2) \frac{1}{z} 
\end{array}
\end{equation}
...
C_{gq}^{L,(1)}(x,z) &:& K_1 = 8 C_F\,,\quad R_1^{(1)}(x) = x\,,\quad
                        R_1^{(2)}(z) = 1-z\,,\\
C_{qg}^{L,(1)}(x,z) &:& K_1 = 1\,,\quad R_1^{(1)}(x) = x(1-x)\,,\quad
                        R_1^{(2)}(z) = 1\,.\\
\end{array}
\end{equation}

For $F_2$ the situation is more complicate but we can still identify
...
\\
&& \displaystyle \left\{K_1 = 2,\, R_1^{(1)}(x) = 1 + 6x+2x^2,\,
   R_1^{(2)}(z) = 1\right\}\,,\\
\\
...
now implement explicitly Eq.~(\ref{eq:MasterFormula}). The one think
...
\begin{array}{rcl}
\displaystyle  F/x &=& \displaystyle C_{qq}  \sum_{q} e_q^2 \left[q  D_q +\overline{q}  D_{\overline{q}}\right]  + C_{gq}  \sum_{q} e_q^2
    \left[q+\overline{q}\right]\,D_g  +  C_{qg}  g \sum_{q} e_q^2
  \left [D_q +D_{\overline{q}}\right]\,,
\end{array}
\end {equation}
where now the sums run only over the quark flavours and not the antiflavours.
