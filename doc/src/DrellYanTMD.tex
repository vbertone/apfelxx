...
S(x_1,x_2,b;\mu,\zeta) =\frac{16\pi\alpha^2}{3N_c Q^3}
    H(Q,\mu) \frac{1}{2}\sum_q C_q(Q) \left[
...
\begin{array}{rcl}
\displaystyle  \widetilde{K}(q_T) &=& \displaystyle \frac{16\pi q_T}{3N_c} \int_0^\infty db\, J_1(bq_T)
...
\begin{equation}
\begin{array}{rcl}
\displaystyle  \widetilde{K}(q_T) &\simeq& \displaystyle \frac{16\pi q_T}{3N_c} \int_0^\infty db\, J_1(bq_T)
...
\displaystyle  \widetilde{K}(q_T) &\simeq& \displaystyle \sum_{n=1}^N
  \sum_{\tau=0}^{N_Q}\sum_{\alpha=0}^{N_\xi}\Bigg[\frac{16\pi q_T}{3N_c} w_n^{(1)}\int_{Q_{\rm min}}^{Q_{\rm max}}dQ\,\mathcal{I}_\tau(Q)\, 
  \frac{\alpha^2(Q)}{Q^3} H(Q) \sum_q C_q(Q)
  \frac12 \\
\\
&\times& \displaystyle 
...
\begin{equation}
\begin{array}{rcl}
  \displaystyle  W_{n\tau\alpha} & \equiv & \displaystyle w_n^{(1)}\frac{16\pi q_T}{3N_c} \int_{Q_{\rm min}}^{Q_{\rm max}}dQ\,\mathcal{I}_\tau(Q)\, 
                                            \frac{\alpha^2(Q)}{Q^3} H(Q) \sum_q C_q(Q)
                                            \frac12 \\
  \\
                                 &\times& \displaystyle 
...
Ref.~\cite{Ogata:quadrature}. There relevant formaulas are:
\begin{equation}
\begin{array}{l}
