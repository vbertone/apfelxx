...
$y=q_T=0$. In this limit $F$ reduces to the expression in
Eq.~(\ref{eq:F00}), while $G$ becomes:
\begin{equation}
\begin{array}{rcl}
\displaystyle G(x ,\eta)&=&\displaystyle 
...
\begin{array}{ll}
0 & \quad Q< 2p_{T,\rm min}\,,\\
 \tanh(\overline{\eta})\left[1-\frac{1}{4\cosh^2(\overline{\eta})}\right]=\left(1+\frac{2p_{T,\rm min}}{Q}\right) \left(1-\frac{p_{T,\rm min}^2}{Q^2}\right)\sqrt{1-\frac{4 p_{T,\rm min}}{Q+2p_{T,\rm min}}}& \quad 2p_{T,\rm min} \leq Q < 2p_{T,\rm min}\cosh\eta_{\rm max}\,,\\
