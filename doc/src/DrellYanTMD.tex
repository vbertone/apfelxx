...
\begin{array}{rcl}
\displaystyle  \widetilde{K}(q_T) &=& \displaystyle \frac{8\pi}{9} \int_0^\infty db\, J_1(bq_T)
...
\begin{equation}
\begin{array}{rcl}
\displaystyle  \widetilde{K}(q_T) &\simeq& \displaystyle \frac{8\pi}{9} \int_0^\infty db\, J_1(bq_T)
