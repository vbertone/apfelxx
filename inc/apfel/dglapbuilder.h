...
namespace apfel
{
   ...
   * functions and matching conditions and store them into a
   * 'DglapObjects' structure. This function prepares the evolution in
   * the physical basis. This variant uses libome for the matching
   * condictions at threshold.
   * @param g: the x-space grid
   * @param Masses: the quark masses
   * @param Thresholds: the quark thresholds
   * @param OpEvol: the switch for the computation of the evolution operator (default: false)
  ...
  /**
   * @brief The InitializeDglapObjectsQCDpolPhys function precomputes
   * the perturbative coefficients of space-like longitudinally
   * polarised splitting functions and matching conditions (assumed to
   * be equal to the unpolarised ones) and store them into a
   * 'DglapObjects' structure. This function prepares the evolution in
   * the physical basis.
   * @param g: the x-space grid
   * @param Masses: the quark masses
  ...
  /**
   * @brief The InitializeDglapObjectsQCDTPhys function precomputes
   * the perturbative coefficients of time-like unpolarised splitting
   * functions and matching conditions and store them into a
   * 'DglapObjects' structure.This function prepares the evolution in
   * the physical basis.
   * @param g: the x-space grid
   ...
   * @brief The InitializeDglapObjectsQCD function precomputes the
   * perturbative coefficients of space-like unpolarised splitting
   * functions and matching conditions in the Krk factorisation scheme
   * and store them into a 'DglapObjects' structure.
   * @param g: the x-space grid
   * @param Masses: the quark masses
   * @param Thresholds: the quark thresholds
   * @param OpEvol: the switch for the computation of the evolution operator (default: false)
   ...
   * @brief The InitializeDglapObjectsQCD function precomputes the
   * perturbative coefficients of space-like unpolarised splitting
   * functions and matching conditions in the PHYS factorisation scheme
   * and store them into a 'DglapObjects' structure.
   * @param g: the x-space grid
   * @param Masses: the quark masses
   * @param Thresholds: the quark thresholds
  ...
  /**
    ...
    * scale. In this function, the DglapObjects do not longer admit a
    * truncated perturbative expasion (as for example in
    * resummation). The relevant objects are to be stored in the key
    * zero of the map of DglapObjects.
    * @param Thresholds: the quark thresholds
    * @param InDistFunc: the distributions at the reference scale
    * @param MuRef: the reference scale
    * @param nsteps: the number of steps of the ODE solver (default: 10).
