...
namespace apfel
{
  ...
  /**
   * @brief The InitializeF2CCObjectsMassive precomputes the
   * perturbative coefficients of coefficient functions for CC F2 in
   * the massive scheme and store them in the
   * 'StructureFunctionObjects' structure.
   * @param g: the x-space grid
   * @param Masses: the heavy quark masses
  ...
  */
  /**
   * @brief The InitializeFLCCObjectsMassive precomputes the
   * perturbative coefficients of coefficient functions for CC FL in
   * the massive scheme and store them in the
   * 'StructureFunctionObjects' structure.
   * @param g: the x-space grid
   * @param Masses: the heavy quark masses
  ...
  */
  /**
   * @brief The InitializeF3CCObjectsMassive precomputes the
   * perturbative coefficients of coefficient functions for CC F3 in
   * the massive scheme and store them in the
   * 'StructureFunctionObjects' structure.
   * @param g: the x-space grid
   * @param Masses: the heavy quark masses
  ...
  */
  /**
   * @brief The InitializeFLCCObjectsMassiveZero precomputes the
   * perturbative coefficients of coefficient functions for
   *  CC FL in the massless limit of the massive scheme and
   * store them in the 'StructureFunctionObjects' structure.
   * @param g: the x-space grid
   * @param Masses: the heavy quark masses
   * @param IntEps: the integration accuracy (default: 10<SUP>-5</SUP>})
  ...
  */
  /**
   * @brief The InitializeF3CCObjectsMassiveZero precomputes the
   * perturbative coefficients of coefficient functions for
   *  CC F3 in the massless limit of the massive scheme and
   * store them in the 'StructureFunctionObjects' structure.
   * @param g: the x-space grid
   * @param Masses: the heavy quark masses
   * @param IntEps: the integration accuracy (default: 10<SUP>-5</SUP>})
