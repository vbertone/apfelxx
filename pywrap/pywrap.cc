...
PYBIND11_MODULE(apfelpy, m)
{
  ...
  _initializers.def("InitializeDglapObjectsQCD", py::overload_cast<apfel::Grid const&, std::vector<double> const&, std::vector<double> const&, bool const&, double const&, std::vector<int> const&>(&apfel::InitializeDglapObjectsQCD), "g"_a, "Masses"_a, "Thresholds"_a, "OpEvol"_a = false, "IntEps"_a = 1e-5, "IMod"_a = std::vector<int> {0, 0, 0, 0, 0, 0, 0});
  _initializers.def("InitializeDglapObjectsQCD", py::overload_cast<apfel::Grid const&, std::vector<double> const&, bool const&, double const&, std::vector<int> const&>(&apfel::InitializeDglapObjectsQCD), "g"_a, "Thresholds"_a, "OpEvol"_a = false, "IntEps"_a = 1e-5, "IMod"_a = std::vector<int> {0, 0, 0, 0, 0, 0, 0});
