...
\int \frac{dx}{(a\pm
  ...
  a)}\pm\frac{2a}{(a^2-1)^{3/2}}\tan^{-1}\left(\frac{x\pm a(1-\sqrt{1-x^2})}{\sqrt{a^2-1}x}\right)\,.
\end{equation}
...
\begin{equation}
\begin{array}{rcl}
&&\displaystyle \frac{1}{2Q^2}\int_0^{2\pi}d\phi\,[\overline{p}_T(\cos\phi)]^2 =\displaystyle \frac{Q^2}{8|\mathbf{q}_T|^2}\int_0^{2\pi}\frac{d\phi}{\left[\frac{M\cosh\left(\eta-y\right)}{|\mathbf{q}_T|}-\cos\phi\right]^2}\\
\\
...
\\
&=&\displaystyle \frac{Q^2}{8}\Bigg\{\frac{2|\mathbf{q}_T|^2 x\sqrt{1-x^2}}{(M ^2\cosh ^2\left(\eta- y\right)-|\mathbf{q}_T|^2)(x^2 |\mathbf{q}_T|^2-
  M ^2\cosh ^2\left(\eta- y\right))}\\
\\
&+&\displaystyle \frac{2M\cosh\left(\eta-
    y\right)}{(M^2\cosh^2\left(\eta-
    y\right)-|\mathbf{q}_T|^2)^{3/2}}\Bigg[\tan^{-1}\left(\frac{x\sqrt{(M^2\cosh^2\left(\eta-y\right)-|\mathbf{q}_T|^2)}}{M\cosh\left(\eta-y\right)\sqrt{1-x^2}}\right)\Bigg]\Bigg\}_{-1}^{1}\\
\\
...
\begin{array}{rcl}
f^{(2)}(\eta, p_{T,\rm cut}) & = &\displaystyle \frac{2M p_{T,\rm cut}\cosh(\eta-y) 
                    - Q^{2}}{2p_{T,\rm cut}
                    |\mathbf{q}_T|}\,, \\
\\
...
\displaystyle F(x ,\eta)=\displaystyle \frac{1}{4\pi}\frac{Q^2}{E_q^2-q_T^2}\Bigg\{\frac{2q_T^2 x\sqrt{1-x^2}}{x^2 q_T^2-
  E_q^2}+ \displaystyle \frac{2E_q}{\sqrt{E_q^2-q_T^2}}\left[\tan^{-1}\left(\frac{x\sqrt{E_q^2-q_T^2}}{\sqrt{1-x^2}E_q}\right)\right]\Bigg\}\
\end{equation}
...
F(x,\eta)=\displaystyle \frac{1}{2\pi}\frac{1}{\cosh^2(\eta)}\left[\tan^{-1}\left(\frac{
...
\displaystyle\int \frac{dx}{(a\pm
  ...
  a)^3}\\
\\
&\pm&\displaystyle\frac{a(2a^2+3)}{2(a^2-1)^{7/2}}\tan^{-1}\left(\frac{x\pm a(1-\sqrt{1-x^2})}{\sqrt{a^2-1}x}\right)\,,
\end{array}
\end{equation}
that is such that:
\begin{equation}
...
\begin{array}{l}
\displaystyle
  \frac{2\sinh^2(y-\eta)}{Q^4}\int_{0}^{2\pi}d(\phi)\overline{p}_T^4(\cos\phi)=\\
\\
...
\begin{array}{rcl}
\displaystyle G(x ,\eta)&=&\displaystyle \frac{1}{16\pi }\sinh^2(y-\eta)\frac{Q^4}{(E_q^2-q_T^2)^3}\Bigg\{\frac{2x\sqrt{1-x^2}q_T^2}{(x^2q_T^2-E_q^2)^3}\\
\\
&\times&\displaystyle\Bigg[q_T^4(11E_q^2q_T^2+4q_T^4)x^4-2 q_T^2(15E_q^4+E_q^2q_T^2-q_T^4)x^2 +3E_q^2(9E_q^4-6E_q^2q_T^2+2q_T^4)\Bigg]\\
\\
&+&\displaystyle\frac{6E_q (2E_q^2+3q_T^2)}{\sqrt{E_q^2-q_T^2}}\left[\tan^{-1}\left(\frac{x\sqrt{E_q^2-q_T^2}}{\sqrt{1-x^2}E_q}\right)\right]
\Bigg\}\,.
\end{array}
\end{equation}
...
\begin{equation}
\begin{array}{rcl}
\displaystyle G(x ,\eta)&=&\displaystyle\frac{3}{2\pi }\frac{\sinh^2(\eta)}{\cosh^4(\eta)}\left[\tan^{-1}\left(\frac{
      x}{\sqrt{1-x^2}}\right)\right]
\,,
\end{array}
\end{equation}
...
\int \frac{dx}{(a\pm
  ...
  a)^2}\pm\displaystyle\frac{(2a^2+1)}{(a^2-1)^{5/2}}\tan^{-1}\left(\frac{x\pm a(1-\sqrt{1-x^2})}{\sqrt{a^2-1}x}\right)\,.
\end{equation}
...
\displaystyle H(x,\eta)&=&\displaystyle\left(\frac {4\pi Q^2}{3}\right)^{-1}\frac{\sinh(y-\eta)}{Q^3}\left[M\cosh(y-\eta) \int
  d(\phi)\overline{p}_T^4(\cos\phi)- |\mathbf{q}_T|
  \int d(\phi) \cos\phi\,\overline{p}_T^4(\cos\phi)\right]\\
\\
&=&\displaystyle\frac{3Q^3 \sinh(y-\eta)}{64\pi |\mathbf{q}_T|^4}\left[M\cosh(y-\eta) \int
  \frac{d(\phi)}{\left(a-\cos\phi\right)^4}-|\mathbf{q}_T|\int
  \frac{\cos\phi \,d(\phi)}{\left(a-\cos\phi\right)^4}\right]\\
\\
&=&\displaystyle\frac{3Q^3 \sinh(y-\eta)}{64\pi q_T^3} \int
  \frac{dx}{\sqrt{1-x^2}}\left[\frac{1}{(a-x)^3}+\frac{1}{(a+x)^3}\right]\\
\\
&=&\displaystyle\frac{3Q^3 \sinh(y-\eta)}{128\pi q_T^3}\Bigg\{\frac{\sqrt{1-x^2}}{(a^2-1)^2}\left[\frac{2ax(3x^2-5a^2+2)}{(x^2-
  a^2)^2}\right]\\
\\
&+&\displaystyle\frac{2(2a^2+1)}{(a^2-1)^{5/2}}\left[\tan^{-1}\left(\frac{x\sqrt{E_q^2-q_T^2}}{\sqrt{1-x^2}E_q}\right)\right]\Bigg\}
\end{array}
\end{equation}
...
\begin{array}{rcl}
\displaystyle H(x,\eta)&=&\displaystyle\frac{3Q^3 \sinh(y-\eta)}{128\pi (E_q^2-q_T^2)^{2}}\Bigg\{\frac{2x\sqrt{1-x^2}E_qq_T^2}{(x^2q_T^2-E_q^2)^2}\left[3x^2q_T^2+2q_T^2-5E_q^2\right]\\
\\
&+&\displaystyle\frac{2(2E_q^2+q_T^2)}{\sqrt{E_q^2-q_T^2}}\left[\tan^{-1}\left(\frac{x\sqrt{E_q^2-q_T^2}}{\sqrt{1-x^2}E_q}\right)\right]\Bigg\}\,.
\end{array}
\end{equation}
