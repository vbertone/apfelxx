...
&+&\displaystyle \mathcal{C}_{\rm
  ...
  \end{array}
\end{equation}
The behaviour under the convolution with interpolating functions
defines a ``double'' operator:
\begin{equation}
\Theta^{\beta\delta,\alpha\gamma}=\int_{x_\delta}^1dy_1 \int_{x_\gamma}^1dy_2\,O(y_1,y_2)w_\beta^{(k)}\left(\frac{x_\delta}{y_1}\right) w_\alpha^{(k)}\left(\frac{x_\gamma}{y_2}\right)\,,
\end{equation}
where the various $\mathcal{C}$ functions are involved as follows:
\begin{equation}
\tiny
  \begin{array}{rcr}
    \displaystyle \Theta^{\beta\delta,\alpha\gamma}&=&\displaystyle \delta_{\beta\delta}\left[\mathcal{C}_{\rm LL}(x_\delta,x_\gamma) \delta_{\alpha\gamma}+\displaystyle
                                                                          \int_{x_\gamma}^1dy_2\,\mathcal{C}_{\rm
                                                                          LS}(x_\delta,y_2)\left[w_\alpha^{(k)}\left(\frac{x_\gamma}{y_2}\right)-\delta_{\alpha\gamma}\right]+\displaystyle
                                                                                        \int_{x_\gamma}^1dy_2\,\mathcal{C}_{\rm LR}(x_\delta,y_2) w_\alpha^{(k)}\left(\frac{x_\gamma}{y_2}\right)\right]\\
\\
    &+&\displaystyle \int_{x_\delta}^1dy_1\left[w_\beta^{(k)}\left(\frac{x_\delta}{y_1}\right)-\delta_{\beta\delta}\right]\left[\mathcal{C}_{\rm SL}(y_1,x_\gamma) \delta_{\alpha\gamma}+
                                                                                                                                                        \int_{x_\gamma}^1dy_2\mathcal{C}_{\rm SS}(y_1,y_2) \left[w_\alpha^{(k)}\left(\frac{x_\gamma}{y_2}\right)-\delta_{\alpha\gamma}\right]+\int_{x_\gamma}^1dy_2\,\mathcal{C}_{\rm SR}(y_1,y_2) w_\alpha^{(k)}\left(\frac{x_\gamma}{y_2}\right)\right]\\
   \\
&+&\displaystyle \int_{x_\delta}^1dy_1w_\beta^{(k)}\left(\frac{x_\delta}{y_1}\right)\left[\mathcal{C}_{\rm RL}(y_1,x_\gamma) \delta_{\alpha\gamma}+
                                                                                                                                                        \int_{x_\gamma}^1dy_2\mathcal{C}_{\rm
    RS}(y_1,y_2)
    \left[w_\alpha^{(k)}\left(\frac{x_\gamma}{y_2}\right)-\delta_{\alpha\gamma}\right]+\int_{x_\gamma}^1dy_2\,\mathcal{C}_{\rm
    RR}(y_1,y_2)
    w_\alpha^{(k)}\left(\frac{x_\gamma}{y_2}\right)\right]\\
\\
&=&\displaystyle \delta_{\beta\delta}\Gamma^{\rm L}_{\alpha\gamma}(x_\delta)+
    \int_{x_\delta}^1dy_1\left[w_\beta^{(k)}\left(\frac{x_\delta}{y_1}\right)-\delta_{\beta\delta}\right]\Gamma^{\rm S}_{\alpha\gamma}(y_1)+  \int_{x_\delta}^1dy_1w_\beta^{(k)}\left(\frac{x_\delta}{y_1}\right) \Gamma^{\rm R}_{\alpha\gamma}(y_1)\,.
  \end{array}
\end{equation}
From the structure of the computation above, it is clear that
$\Theta^{\beta\delta,\alpha\gamma}$ is constructed by first
constructing three ``single'' operators,
$\Gamma^{\rm L}_{\alpha\gamma}(y_1)$,
$\Gamma^{\rm S}_{\alpha\gamma}(y_1)$,
$\Gamma^{\rm R}_{\alpha\gamma}(y_1)$, functions of an ``external''
variable $y_1$ that are in turn treated as singular, local, and
regular components of the double operator.
