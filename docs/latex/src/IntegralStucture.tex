...
\begin{equation}
J_{\beta\alpha}=\int_{x_{\beta}}^{1}dy\,\left(\frac{1}{1-\kappa y}\right)_{\rm
PV}w_{\alpha}\left(\frac{x_{\beta}}{y}\right) \,.
\end{equation}
As above, the support region of the interpolation functions
$w_\alpha(x_\beta/y)$, that is
$y\in [x_\beta/x_{\alpha+1},x_\beta/x_{{\rm max}[0,\alpha-\kappa]}]$,
requires some care:
\begin{equation}
\begin{array}{rcl}
  J_{\beta\alpha}&=&\displaystyle \int_{x_{\beta}}^{1}dy\,\left(\frac{1}{1-\kappa y}\right)_{\rm
                     PV}w_{\alpha}\left(\frac{x_{\beta}}{y}\right)\\
  \\
                 &=&\displaystyle \int_{c}^1\frac {dy}{1-\kappa y}
                     \left[w_{\alpha}\left(\frac{x_{\beta}}{y}\right)-w_{\alpha}\left(\xi\right)\left(1+\theta\left(\kappa y-1\right)\frac{1-\kappa
                     y}{\kappa
                     y}\right)\right]+w_{\alpha}\left(\xi\right)\frac{1}{\kappa}\ln\left(\frac{\kappa(1-\kappa c)}{\kappa -1 }\right)\\
  \\
                 &=&\displaystyle \int_{c}^{d}\frac {dy}{1-\kappa y}
                     \left[w_{\alpha}\left(\frac{x_{\beta}}{y}\right)-w_{\alpha}\left(\xi\right)\left(1+\theta\left(\kappa y-1\right)\frac{1-\kappa
                     y}{\kappa
                     y}\right)\right]\\
  \\
                 &+&\displaystyle
                     w_{\alpha}\left(\xi\right)\left[\frac{1}{\kappa}\ln\left(\frac{\kappa(1-\kappa c)}{\kappa -1 }\right)
                     -\int_{d}^1\frac {dy}{1-\kappa y}
                     \left(1+\theta\left(\kappa y-1\right)\frac{1-\kappa
                     y}{\kappa y}\right)\right]\\
  \\
                 &=&\displaystyle \int_{c}^{d}\frac {dy}{1-\kappa y}
                     \left[w_{\alpha}\left(\frac{x_{\beta}}{y}\right)-w_{\alpha}\left(\xi\right)\left(1+\theta\left(\kappa y-1\right)\frac{1-\kappa
                     y}{\kappa
  ...
  \\
                 &+&\displaystyle
                     w_{\alpha}\left(\xi\right) \frac{1}{\kappa}\left[\ln\left(\frac{\kappa(1-\kappa c)}{\kappa -1 }\right)
                     -\int_{\kappa d}^\kappa \frac {dz}{1-z}
                     \left(1+\theta\left(z-1\right)\frac{1-z}{z}\right)\right]\\
  \\
                 &=&\displaystyle \int_{c}^{d}\frac {dy}{1-\kappa y}
                     \left[w_{\alpha}\left(\frac{x_{\beta}}{y}\right)-w_{\alpha}\left(\xi\right)\left(1+\theta\left(\kappa y-1\right)\frac{1-\kappa
                     y}{\kappa
  ...
  \\
                 &+&\displaystyle
                     ...
                     \frac{1}{\kappa}\left[\ln\left(\frac{\kappa(1-\kappa
                     c)}{\kappa - 1}\right)
                     -\ln\left(\frac{1-\kappa d}{\kappa -1}\right)
                     -\ln\left(\kappa\right)\right]\\
  \\
                 &=&\displaystyle \int_{c}^{d}\frac {dy}{1-\kappa y}
                     \left[w_{\alpha}\left(\frac{x_{\beta}}{y}\right)-w_{\alpha}\left(\xi\right)\left(1+\theta\left(\kappa y-1\right)\frac{1-\kappa
                     y}{\kappa
                     y}\right)\right]+
                     w_{\alpha}\left(\xi\right)\frac{1}{\kappa}\ln\left(\frac{1-\kappa c}{1-\kappa d}\right)
\,.
\end{array}
\end{equation}
