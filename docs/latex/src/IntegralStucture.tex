...
\begin{equation}
  J(x_\beta) =
  \sum_{g=0}^{N_g-1}\int_{x_\beta/x_{\gamma^{(g+1)}}}^{x_\beta/x_{\gamma^{(g)}}}dy\,O(y)f\left(\frac{x_\beta}{y}\right)
...
\begin{equation}
  ...
  \int_{\overline{c}}^{\overline{d}}dy\,O(y)w_{\alpha-\gamma^{(g)}}\left(\frac{x_{\beta}}{y}\right)=\sum_{\alpha=\gamma^{(g)}}^{\gamma^{(g+1)}+\kappa^{(g)}-1}J_{\beta\alpha}^{(g)}\,\overline{d}_\alpha\,,
...
J_{\beta\alpha}^{(g)}=\sum_{j={\rm
    ...
    min}[\kappa^{(g)},\alpha-\gamma^{(g)}]}\int_{s^{\beta-\alpha+j-1}}^{s^{\beta-\alpha+j}}dy\,O(y)w_{\alpha-\gamma^{(g)}}\left(\frac{x_\beta}{y}\right)\,,
