...
\begin{equation}
\begin{array}{rcl}
  \displaystyle\mathcal{F}_{i}^{\rm NC}&=&\displaystyle C_{qq}^{{\rm NS},i}\sum_{\alpha}B_{\alpha\alpha}d_\alpha f_\alpha+C_{gq}^{i}\sum_\alpha B_{\alpha\alpha}d_g f_\beta+C_{qg}^{i}\sum_\alpha B_{\alpha\alpha}d_\alpha f_g \\ 
\\
...
\begin{array}{rcl}
  ...
  \\
  &+&\displaystyle C_{gg}^{i}\sum_{{\alpha\in U\atop\beta\in D}}|V_{\alpha\beta}|^2d_gf_g +C_{qq,\rm Fcon,2}^{i}\sum_{{\alpha\in U\atop\beta\in D}}|V_{\alpha\beta}|^2\sum_{f\in Q}(d_ff_f+d_{\overline{f}}f_{\overline{f}})+C_{\overline{q}q}^{i}\sum_{{\alpha\in U\atop\beta\in D}}|V_{\alpha\beta}|^2(d_{\overline{\beta}}f_\alpha+d_{\alpha}f_{\overline{\beta}})\\
  \\
...
\begin{array}{rcl}
  ...
  \\
  &+&\displaystyle C_{gg}^{i}\sum_{{\alpha\in D\atop\beta\in U}}|V_{\alpha\beta}|^2d_gf_g +C_{qq,\rm Fcon,2}^{i}\sum_{{\alpha\in D\atop\beta\in U}}|V_{\alpha\beta}|^2\sum_{f\in Q}(d_ff_f+d_{\overline{f}}f_{\overline{f}})+C_{\overline{q}q}^{i}\sum_{{\alpha\in D\atop\beta\in U}}|V_{\alpha\beta}|^2(d_{\overline{\beta}}f_\alpha+d_{\alpha}f_{\overline{\beta}})\\
  \\
