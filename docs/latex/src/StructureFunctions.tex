...
depends on the diagram under consideration, more specifically on 
number and configuration of heavy-quark masses which
participate. Therefore, $F^{\rm M}$ may receive contributions from
...
coefficients function may simultaneously depend of multiple heavy-quark
