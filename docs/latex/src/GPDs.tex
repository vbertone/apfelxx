...
\subsubsection{The singlet sector}
...
\mathcal{P}_{1,\rm SS}^{(0)}(y,\kappa) = - \lim_{y\rightarrow \kappa^{-1}} (1-\kappa^2y^2)^2
...
\end{equation}
In order to get right of the $i\varepsilon$ that complicates the
...
\begin{array}{rcl}
  ...
  \\
                                        &-& \displaystyle \pi C_F\delta(1-y)\left\{
                                            \frac{9}{2} +\pi^2+
