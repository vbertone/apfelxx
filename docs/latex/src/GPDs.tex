...
function $\mathcal{P}_2^{-,(0)}$ is singular at $y=1$.\footnote{While
  the singularity at $y=-1$ is all placed below the lower bound $y=x$
  and thus does not cause any problem, there is an additional
  singularity at $y=\pm1/\kappa$ that needs to be considered. As
  discussed below, this singularity in $\mathcal{P}_2^{-,(0)}$ exactly
  cancels against an opposite singularity in $\mathcal{P}_1^{-,(0)}$.}
However, as pointed out above, the second integral on the r.h.s. of
...
\begin{equation}
\lim_{y\rightarrow \kappa} (1-\kappa^2y^2)
\mathcal{P}_1^{-,(0)}(y,\kappa) = -2 C_F (1+\kappa)\,,
\end{equation}
and:
\begin{equation}
\lim_{y\rightarrow \kappa} (1-\kappa^2y^2)
\mathcal{P}_2^{-,(0)}(y,\kappa) = 2 C_F (1+\kappa)\,.
\end{equation}
...
\\
\mathcal{P}_{2,\rm SS}^{(0)}(y,\kappa) &=& \displaystyle 2C_F\left[\frac{(1+\kappa)(1+y)+\kappa^3y^2}{(1+y)(1-\kappa^2y^2)}-\left(\frac{1}{1-y}\right)_{++}\right]\,,
\end{array}\right.
\end{equation}
...
\\
&+&\displaystyle\delta(1-y)\left(\frac{11C_A-4T_R n_f}{3}\right)\,,\\
  \\
  \mathcal{P}_{2,\rm GG}^{(0)}(y,\kappa) &=& \displaystyle 2C_A\frac{1-\kappa^2}{1-\kappa^2y^2}\left[\frac{2(1+y^2)}{(1+\kappa)(1-\kappa^2y^2)}-\frac{1}{\kappa}+2-\frac{1}{1+y}-\left(\frac{1}{1-y}\right)_{++}\right]\,.
\end{array}\right.
\end{equation}
Notice that for $\mathcal{P}_{1,\rm GG}^{(0)}$ we have used the
integral:
\begin{equation}
...
\\
  ...
  \\
  \mathcal{P}_{1,\rm GG}^{(0)}(y,1) &=& \displaystyle 4C_A\left[\left(\frac{1}{1-y^2}\right)_++\frac{1}{y(1+y)^2}\right]+\delta(1-y)\left(\frac{11C_A-4T_R n_f}{3}\right)\,,
\end{array}
\end{equation}
...
$\mathcal{P}_{1,\rm IJ}^{(0)}$ and $\mathcal{P}_{2,\rm IJ}^{(0)}$. Since $\mathcal{P}_{1(2),\rm SS}^{(0)}=\mathcal{P}_{1(2)}^{-,(0)}$, we do not need to do it
again for the SS splitting functions. For the others we find:
\begin{equation}
\lim_{y\rightarrow \kappa} (1-\kappa^2y^2)^2
\mathcal{P}_{1,\rm SG}^{(0)}(y,\kappa) = - \lim_{y\rightarrow \kappa} (1-\kappa^2y^2)^2
\mathcal{P}_{2,\rm SG}^{(0)}(y,\kappa) = \frac{8 n_f T_R(1-\kappa)}{\kappa}\,,
\end{equation}
\begin{equation}
\lim_{y\rightarrow \kappa} (1-\kappa^2y^2)
\mathcal{P}_{1,\rm GS}^{(0)}(y,\kappa) = - \lim_{y\rightarrow \kappa} (1-\kappa^2y^2)
\mathcal{P}_{2,\rm GS}^{(0)}(y,\kappa) = 2C_F\frac{(1-\kappa)^2}{\kappa}\,,
\end{equation}
\begin{equation}
\lim_{y\rightarrow \kappa} (1-\kappa^2y^2)^2
\mathcal{P}_{1,\rm GG}^{(0)}(y,\kappa) = - \lim_{y\rightarrow \kappa} (1-\kappa^2y^2)^2
...
&+&\displaystyle \left(\frac{11C_A-4T_R
    n_f}{6}\right)\delta\left(u-t\right)\,.
\end{array}
\end{equation}
