...
\\
 &+&\displaystyle a_s ^3 (Q) \left[L
  P^{{(2)}} +L^2 \left(P^{{(0)}} P^{{(1)}}+\frac{\beta
      _1 P^{{(0)}}}{2}+\beta _0 P^{{(1)}}\right)+L^3
  \left(\frac{1}{2} \beta _0 \left(P^{{(0)}}\right)^2+\frac{1}{3}
    \beta _0^2
    P^{{(0)}}+\frac{\left(P^{{(0)}}\right)^3}{6}\right)\right]\\
\\
&+&\displaystyle \mathcal{O}(a_s^4)\,.
\end{array}
...
\\
\displaystyle-a_s ^3 (Q) \left[L P^{{(2)}} +L^2 \left(-P^{{(0)}} P^{{(1)}}+\frac{1}{2} \beta _1 P^{{(0)}}+\beta _0 P^{{(1)}}\right)+L^3 \left(-\frac{1}{2} \beta _0 \left(P^{{(0)}}\right)^2+\frac{1}{3} \beta _0^2 P^{{(0)}}+\frac{1}{6} \left(P^{{(0)}}\right)^3\right)\right]\\
\\
+\mathcal{O}(a_s^4) \,.
\end{array}
\label{eq:DGLAPeqOp1}
...
\\
                       ...
                       P^{{(0)}}\right]\\
\\
&+&\displaystyle a_s^2 (Q) \left[C^{{(2)}} +L \left(-P^{{(0)}} C^{{(1)}}+\beta _0 C^{{(1)}}-P^{{(1)}}\right)+L^2 \left(\frac{\left(P^{{(0)}}\right)^2}{2}-\frac{\beta _0 P^{{(0)}}}{2}\right)\right]\\
\\
&+&\displaystyle a_s^3 (Q) \bigg[C^{{(3)}} +L \left(-P^{{(0)}}
    C^{{(2)}}-C^{{(1)}} P^{{(1)}}+\beta _1 C^{{(1)}}+2 \beta _0
    C^{{(2)}}-P^{{(2)}}\right)\\
\\
&+&\displaystyle L^2 \left(-\frac{3}{2} \beta _0 P^{{(0)}}
    C^{{(1)}}+\frac{1}{2} \left(P^{{(0)}}\right)^2 C^{{(1)}}+P^{{(0)}}
    P^{{(1)}}-\frac{\beta _1 P^{{(0)}}}{2}+\beta _0^2 C^{{(1)}}-\beta
    _0 P^{{(1)}}\right)\\
\\
&+&\displaystyle L^3 \left(\frac{1}{2} \beta _0 \left(P^{{(0)}}\right)^2-\frac{1}{3} \beta _0^2 P^{{(0)}}-\frac{1}{6} \left(P^{{(0)}}\right)^3\right)\bigg]\bigg\}\otimes f(Q)\\
\\
&+&\displaystyle \mathcal{O}(a_s^4)\,.
\end{array}
...
\\
\displaystyle I_6(q_T,Q) = - \frac{6}{q_T^2}\left[\ln^5\left(\frac{Q^2}{q_T^2}\right)-20\zeta_3 \ln^2\left(\frac{Q^2}{q_T^2}\right)-4\zeta_5\right]\,.
\end{array}
\label{eq:PureLogs}
\end{equation}
...
\begin{array}{rcl}
  {B}_{ij,kl}^{(3,1)}(x,z) &=&
H_{ij}^{(2)}\tilde{S}^{(1,1)}
                               \left[\mathcal{C}_{ik}^{(0)}(x)\mathbb{C}_{jl}^{(0)}(z)
