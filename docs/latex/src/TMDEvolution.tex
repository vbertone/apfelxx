...
\begin{array}{rcl}
  f(\mu_0) &=&\displaystyle  \Gamma(\mu_0,\mu_F)\otimes f(\mu_F) =
               ...
               f(\mu_F)\\
  \\
           &=& \displaystyle \Gamma(\mu_0,\mu_F)\otimes \Bigg[\Delta -
...
$a_s(\kappa_R Q)$. At LL and NLL the square bracket does not need to
include and $\alpha_s$ corrections while N$^k$LL requires including
